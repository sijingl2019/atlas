...
const ALLOWED: Allowed[] = [
  // ── fixed components ──
  { file: "features/hint-nav/components/hint-overlay.tsx", snippet: `color: "rgba(255,255,255,0.95)"`, reason: KEYCAP },
  { file: "features/hint-nav/components/hint-overlay.tsx", snippet: `border: "1px solid rgba(255,255,255,0.08)"`, reason: KEYCAP },
  { file: "features/hint-nav/components/hint-overlay.tsx", snippet: `"inset 0 1px 0 rgba(255,255,255,0.12), inset 0 -1px 0`, reason: KEYCAP },
  { file: "features/hint-nav/components/hint-overlay.tsx", snippet: `boxShadow: "inset 0 1px 0 rgba(255,255,255,0.1), 0 8px 28px`, reason: KEYCAP },
  { file: "features/comms/components/comms-home.tsx", snippet: `ink="rgba(255,255,255,0.95)"`, reason: KEYCAP },
  { file: "features/comms/components/comms-home.tsx", snippet: `border: "1px solid rgba(255,255,255,0.08)"`, reason: KEYCAP },
  { file: "features/comms/components/comms-home.tsx", snippet: `"inset 0 1px 0 rgba(255,255,255,0.12), inset 0 -1px 0`, reason: KEYCAP },
  { file: "features/organisations/components/org-switcher.tsx", snippet: `color: "rgba(255,255,255,0.95)"`, reason: KEYCAP },
  { file: "features/organisations/components/org-switcher.tsx", snippet: `border: "1px solid rgba(255,255,255,0.08)"`, reason: KEYCAP },
  { file: "features/organisations/components/org-switcher.tsx", snippet: `"inset 0 1px 0 rgba(255,255,255,0.12), inset 0 -1px 0`, reason: KEYCAP },
  { file: "components/titlebar.tsx", snippet: `leading-none font-medium text-white"`, reason: "session-capture pill: white on its blue gradient" },
  { file: "components/titlebar.tsx", snippet: `rgba(37,99,235,0.35), 0 1px 0 0 rgba(255,255,255,0.25) inset`, reason: "session-capture pill highlight" },
  { file: "components/titlebar.tsx", snippet: `"linear-gradient(180deg, rgba(255,255,255,0.25) 0%`, reason: "session-capture pill sheen" },
  { file: "components/titlebar.tsx", snippet: `"0 0 0 1px rgba(255,255,255,0.10) inset`, reason: "session-capture pill rim" },
  { file: "components/titlebar.tsx", snippet: `hover:bg-[#e81123]`, reason: "Windows close-button red, same in every theme" },

  // ── on a colored fill ──
  { file: "features/auth/components/account-avatar.tsx", snippet: "text-white/90", reason: COLORED_FILL },
  { file: "features/comms/components/comms-avatar.tsx", snippet: "text-white/90", reason: COLORED_FILL },
  { file: "features/comms/lib/mention-pill.ts", snippet: "text-white/90", reason: COLORED_FILL },
  { file: "features/explorer/components/file-tree-confirm-delete.tsx", snippet: `"text-white bg-[var(--status-error)]`, reason: COLORED_FILL },
  { file: "features/organisations/components/org-switcher.tsx", snippet: "bg-error text-white", reason: COLORED_FILL },
  { file: "features/spaces/components/space-cursors.tsx", snippet: `leading-none text-white"`, reason: "cursor label on the collaborator's color" },
  { file: "features/feedback/components/feedback-panel.tsx", snippet: "bg-black/70 text-white/80", reason: "remove button over an image thumbnail" },
  { file: "features/canvas/components/node-handles.tsx", snippet: "!border-white/40 !bg-[var(--accent-primary)]", reason: COLORED_FILL },
  { file: "features/canvas/components/shape-node.tsx", snippet: "!bg-[var(--accent-primary)] !border-white/60", reason: COLORED_FILL },
  { file: "features/spaces/components/space-nodes.tsx", snippet: "!bg-[var(--accent-primary)] !border-white/60", reason: COLORED_FILL },
  { file: "features/git/components/git-manager/git-error-dialog.tsx", snippet: "never `text-white`", reason: "comment" },
  { file: "features/git/components/git-manager/merge-branch-dialog.tsx", snippet: "never `text-white`", reason: "comment" },

  // ── content that is light or dark regardless of theme ──
  { file: "features/pdf/components/pdf-viewer.tsx", snippet: "relative bg-white shadow-lg", reason: "PDF page" },
  { file: "features/pdf/components/pdf-viewer.tsx", snippet: `flex items-center justify-center bg-white`, reason: "PDF page placeholder" },
  { file: "features/comms/components/media-lightbox.tsx", snippet: "h-full w-full bg-black object-contain", reason: "media letterboxing" },
  { file: "features/comms/components/message-group.tsx", snippet: "border-border-subtle bg-black", reason: "media letterboxing" },
  { file: "features/settings/components/settings-panel.tsx", snippet: `"translate-x-0 bg-white"`, reason: "toggle knob, white on any track" },

  // ── the terminal ──
  { file: "features/terminal/components/block-terminal.tsx", snippet: "bg-[#000] px-1 py-1", reason: XTERM },
  ...
  { file: "styles/globals.css", snippet: "var(--cm-active-line-bg, rgba(255, 255, 255, 0.04))", reason: "fallback pinned by css-fallbacks.test.ts" },
];
...
describe("hardcoded colors", () => {
  ...
  it("has no allowlist entries whose code is gone", () => {
    const stale = ALLOWED.filter((a) => !hits.some((h) => h.file === a.file && h.line.includes(a.snippet))).map(
      (a) => `${a.file}: ${a.snippet}`,
    );
  ...
  it("still recognizes the pattern it exists to stop", () => {
    ...
    expect(found).toEqual(["hover:bg-white/5", "border-white/[0.07]", "rgba(255,255,255,", "text-[#aaa]"]);
  });
});
