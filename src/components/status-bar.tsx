...
export function StatusBar() {
  ...
  return (
    <div
      className="h-7 flex items-center justify-between px-3 shrink-0 bg-bg-base border-t border-border-default text-[11px] font-mono text-[var(--text-muted)] select-none relative"
