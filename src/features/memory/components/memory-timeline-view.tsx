    ...
    <div className="h-full flex flex-col bg-[var(--bg-base)]">
      ...
      <div className="flex-1 min-h-0 relative">
        ...
        <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-10 w-[min(620px,calc(100%-40px))]">
          <div className="flex items-center gap-2.5 h-11 rounded-full bg-[#141414]/95 backdrop-blur-2xl shadow-[0_10px_40px_color-mix(in_srgb,var(--shade)_60%,transparent)] border border-contrast/[0.12] px-4">
