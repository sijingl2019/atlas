    ...
    <div className="relative flex min-w-0 flex-1 flex-col items-center justify-center gap-2.5 overflow-hidden px-8 text-center">
      ...
      {org && (
        <button
          ...
          // inside this panel).
          className="relative mt-1 flex h-[30px] items-center gap-1.5 rounded-full border border-contrast/15 bg-contrast/10 px-4 text-[11.5px] font-medium text-text-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] backdrop-blur-md transition-colors hover:bg-contrast/15 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
        >
          {syncing ? (
